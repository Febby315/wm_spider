const config={
    ...
    db_list_source_add:"/spiderdb/listsource/add",//列表源(增加)
    //2 列表内容抓取
    ...
    db_list_detail_source_query:"/spiderdb/listdetailsource/list",//详情源(查询)
    db_list_detail_source_edit:"/spiderdb/listdetailsource/edit",//详情源(编辑)
    db_list_detail_cleaned_add:"/spiderdb/listdetailcleaned/add",//已清洗详情(增加)
    //6 附件资源下载
    ...
    downImg_server:"http://localhost:3001",//*附件下载服务地址
    downImg_down:"/spiderdb_img_download/updownload/download",//*附件下载接口
    ...
    db_price_add:"/spiderdb/price/add",//价格(增加)
